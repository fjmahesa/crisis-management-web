    ...
    <main className="pt-28 pb-24 bg-white dark:bg-[#050505] text-slate-900 dark:text-slate-100 font-sans transition-colors duration-500">
      <div className="max-w-7xl mx-auto px-4 md:px-6">
        ...
        <nav className="text-[11px] font-medium text-slate-400 uppercase tracking-wider mb-6 flex items-center gap-2">
          ...
          <span>›</span>
          {/* Diarahkan kembali ke rute /blog utama */}
          <Link to="/blog" className="hover:text-red-600">{categories[0]?.name || 'Blog'}</Link>
        </nav>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-8 border-r-0 lg:border-r border-slate-100 dark:border-white/5 lg:pr-8">
            ...
            {/* SUBJUDUL / RINGKASAN TEKS (Sudah diperbaiki ke data excerpt asli) */}
            <div 
              className="text-slate-400 dark:text-slate-500 text-sm md:text-base leading-relaxed mb-6 font-medium uppercase tracking-wide"
          ...
          {/* SISI KANAN: SIDEBAR POPULAR NEWS */}
                  ...
                  return (
                    ...
                    >
                      ...
                      {index === 0 && pImage ? (
                        ...
                        // Item urutan berikutnya berupa daftar teks dengan nomor indeks besar
                        index !== 0 && (
                          <>
