      ...
      <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-16 items-center relative z-10">
        ...
        >
          ...
          <motion.div variants={fadeIn("up")} className="flex flex-wrap gap-4">
            <button href="https://wa.me/6282226644882" className="bg-red-600 text-white px-8 py-4 font-black text-[10px] uppercase tracking-[0.2em] hover:bg-red-700 transition-all shadow-xl shadow-red-600/20">
