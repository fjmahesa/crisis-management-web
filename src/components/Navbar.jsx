...
import useDarkMode from '../hooks/useDarkMode'; // Import hook tema
import { FaSun, FaMoon } from 'react-icons/fa'; // Pastikan react-icons sudah terinstal
...
export default function Navbar() {
  ...
  return (
    <nav className="sticky top-0 w-full transition-colors duration-700 bg-white/80 dark:bg-[#050505]/80 backdrop-blur-xl border-b border-slate-200 dark:border-white/5 px-6 py-4 md:px-12 flex items-center justify-between z-[100]">
      
      {/* LOGO */}
      <Link to="/" className="text-xl md:text-2xl font-black tracking-tighter text-[#0F172A] dark:text-white z-[110] transition-colors duration-500">
      ...
      <div className="flex items-center gap-8 md:gap-10">
        ...
        {/* DESKTOP MENU LINKS */}
        <div className="hidden md:flex items-center gap-10 font-mono text-[10px] tracking-[0.2em] uppercase font-bold">
        ...
        {/* THEME TOGGLE BUTTON (Dewasa & Minimalis) */}
        <motion.button
          whileTap={{ scale: 0.9 }}
          onClick={toggleTheme}
